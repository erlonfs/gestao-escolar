...
{
	public class Quando_rematricular_aluno
	{
		...
		public Quando_rematricular_aluno()
		{
			...
			TestAsyncHelper.CallSync(() => _service.RematricularAsync(_alunoId, _responsavelId,  _escolaId, _salaId).Wait());
